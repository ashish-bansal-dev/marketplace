...
export class Migration20250503095352 extends Migration {
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table if exists "seller_verification" drop constraint if exists "seller_verification_seller_id_foreign";`);
