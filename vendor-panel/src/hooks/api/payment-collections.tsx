...
export const useCreatePaymentCollection = (
  ...
  return useMutation({
    mutationFn: (payload) => sdk.vendor.paymentCollection.create(payload),
...
export const useMarkPaymentCollectionAsPaid = (
  ...
  return useMutation({
    mutationFn: (payload) =>
      sdk.vendor.paymentCollection.markAsPaid(paymentCollectionId, payload),
    onSuccess: (data, variables, context) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.details(),
      })
...
export const useDeletePaymentCollection = (
  ...
  return useMutation({
    mutationFn: (id: string) => sdk.vendor.paymentCollection.delete(id),
    onSuccess: (data, variables, context) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.details(),
      })
