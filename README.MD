...
- [ ] **Stock location and inventory management**. Sellers can create stock locations and manage their inventory.
...
- [ ] **Order splitting**. Orders are split into multiple orders by sellers in the cart.
...
git clone https://github.com/ashish-bansal-dev/marketplace
